...
v0.5.5 Rename "div" to make more semantic. *\(Github copilot did it\)*
...
v0.3.3 A warning when the user disabled JavaScript.
...
v0.1.3 "div" tag when class="text" *\(Excerpt from commit message\)*
